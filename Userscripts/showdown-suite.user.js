...
// @version      1.0.0
// @description  All-in-one: custom music player, QoL shortcuts/avatar/room filter, teambuilder folders, battle/replay/OTS tools, rainbow menu buttons.
// @author       You
...
(function () {
	...
	// Swap this for any avatar filename from Showdown's own sprite set
	// (https://play.pokemonshowdown.com/sprites/trainers/) or your own
	// hosted image.
	...
	// Edit this list to whichever rooms you actually want to see by default.
...
`);
	...
	console.log('[Showdown Suite] v1.0.0 loaded - Music, QoL, Move to Folder, Battle Update, Rainbow Buttons.');
})();
